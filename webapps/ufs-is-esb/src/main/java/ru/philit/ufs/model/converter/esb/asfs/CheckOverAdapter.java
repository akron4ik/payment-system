...
public class CheckOverAdapter extends AsfsAdapter {
    ...
    private static boolean limitStatusType(LimitStatusType limitStatusType){
        return (limitStatusType.value().equals(LIMIT_ERROR));
    }

    private static void map(CheckOverLimitRequest params, SrvCheckOverLimitRq.SrvCheckOverLimitRqMessage message) {
